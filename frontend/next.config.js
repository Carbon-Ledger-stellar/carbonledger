...
const nextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_SDEX_CARBON_CODE: process.env.NEXT_PUBLIC_SDEX_CARBON_CODE || "CARBON",
    NEXT_PUBLIC_SDEX_CARBON_ISSUER: process.env.NEXT_PUBLIC_SDEX_CARBON_ISSUER || "",
    NEXT_PUBLIC_SDEX_USDC_CODE: process.env.NEXT_PUBLIC_SDEX_USDC_CODE || "USDC",
    NEXT_PUBLIC_SDEX_USDC_ISSUER: process.env.NEXT_PUBLIC_SDEX_USDC_ISSUER || "",
